...
import static com.fawrysystem.app.Provider.ProviderService.TEXT_FIELD_CODE;
...
public class FawrySystem {
    ...
    public static void main(String[] args) {
        ...
        ProviderModel provider = new ProviderModel("My Provider",
                new Component( TEXT_FIELD_CODE, "Number"),
                new Component(TEXT_FIELD_CODE, "Amount")
        );
        provider.handler(new UserModel("Abdelaziz", "zezo.zoz@gmail.com", "12356"),
                100.0);
        ...
        List<IServiceProvider> serviceProviders = new ArrayList<>();
...
//                    System.out.println(currentUserService.getProviderName() + " Selected ");
//                    currentUserService.ExecuteService();
                    ...
                    if (payFlag == 1) {
                        ...
                        for (IServiceProvider serviceProvider : serviceProviders) {
                            ...
                            System.out.println(serviceProvider.getProviderName());
                            ind++;
                        }
...
//                            tr.setTransactionName(currentUserService.getProviderName());
